...
tags: ["query:autoai"]
score: 6.0
evidence: 针对视频分析的高效流式视觉语言模型推理
tldr: CodecSight利用视频编解码信号减少冗余，降低流式视觉语言模型推理的成本。
source: arxiv
...
motivation: 针对视频分析的高效流式视觉语言模型推理。
method: 方法与实现细节请参考摘要与正文。
result: Experiments show that CodecSight achieves an improvement in throughput of up to 3$。
